...
namespace Doctors_Desktop.DataSet4TableAdapters {
...
SELECT ID, Name, Age, Gender, Address, PhoneNo, Disease FROM Patient_Information WHERE (ID = @ID)";
        ...
        public virtual int Fill(DataSet4.Patient_InformationDataTable dataTable) {
        ...
        public virtual DataSet4.Patient_InformationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet4.Patient_InformationDataTable dataTable = new DataSet4.Patient_InformationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet4.Patient_InformationDataTable dataTable) {
